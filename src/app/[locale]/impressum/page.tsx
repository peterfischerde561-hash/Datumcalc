    ...
    return (
        <div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="article-body space-y-12">
                <section>
                    <h2 className="text-2xl font-bold text-ink mb-4">Angaben gemäß § 5 DDG</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-ink mb-4">Kontakt</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-ink mb-4">Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
                    <p className="text-ink-2 leading-relaxed">
                        Leon Fischer <br />
                ...
                <section>
                    <h2 className="text-2xl font-bold text-ink mb-4">Haftung für Inhalte</h2>
                    <p className="text-ink-2 leading-relaxed">
